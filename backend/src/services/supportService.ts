...
export const DEFAULT_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: `<b>Тарифные планы Funding Finder:</b>\n\n` +
      ...
      `• <b>Pro ($29/мес или 3 дня триал):</b> 15 бирж, расширенный арбитражный сканер, Spot-Futures матрица, AI-анализ связок, симулятор портфеля, настраиваемые алерты в Telegram.\n` +
      `• <b>Pro+ ($79/мес):</b> Все 31+ бирж (включая DEX: Hyperliquid, dYdX, Drift, Paradex), API-доступ, авто-исполнение сделок и приоритетная поддержка 24/7.`,
