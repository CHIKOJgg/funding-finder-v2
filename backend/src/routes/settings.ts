...
const updateSettingsSchema = z.object({
  ...
  spreadNotifications: z.boolean().optional(),
  spreadMinThreshold: z.number().min(0).optional(),
  pushoverNotifications: z.boolean().optional(),
  pushoverKey: z.string().max(40).optional().nullable(),
  pushoverDevice: z.string().max(40).optional().nullable(),
