...
const FEATURE_INFO: Record<PaywallFeature, {
  ...
  exchanges: {
    icon: '🔁',
    title: 'Больше бирж',
    desc: 'Ваш тариф позволяет сканировать ограниченное число бирж. Подключите Pro, чтобы сравнивать все 5 бирж сразу и находить самые выгодные ставки фандинга.',
    plan: 'Pro',
  },
  ai: {
    icon: '🧠',
