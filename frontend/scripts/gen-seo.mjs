...
const UI = {
  en: {
    ...
    faqH: 'FAQ',
    relatedH: 'Related',
    ctaH: 'Scan 31 exchanges in one click',
  ...
  ru: {
    ...
    faqH: 'Частые вопросы',
    relatedH: 'Похожее',
    ctaH: 'Сканируй 31 биржу в один клик',
  ...
  tr: {
    ...
    faqH: 'SSS',
    relatedH: 'İlgili',
    ctaH: "31 borsayı tek tıkla tara",
  ...
  vi: {
    ...
    relatedH: 'Liên quan',
    ctaH: 'Quét 31 sàn chỉ bằng một cú nhấp',
  ...
  hi: {
    ...
    relatedH: 'संबंधित',
    ctaH: '31 exchanges को एक क्लिक में स्कैन करें',
